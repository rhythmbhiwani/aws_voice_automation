...
language = 'en'
r = sr.Recognizer()
client = boto3.client('ec2',aws_access_key_id='AKIATYQM3QPMSGAGLKJM',aws_secret_access_key='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',region_name='us-east-2')
ec2 = boto3.resource('ec2',aws_access_key_id='AKIATYQM3QPMSGAGLKJM',aws_secret_access_key='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',region_name='us-east-2')
